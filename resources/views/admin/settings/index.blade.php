                        ...
                        <form method="post" action="{{ route('admin.settings.basic') }}" class="mt-6 space-y-6"
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="pt-4 border-t border-gray-100">
                                    <h3 class="text-sm font-semibold text-gray-800 mb-4">Guest Login Portal
                                        Configuration</h3>
                            ...
                            <div
                                class="flex flex-col sm:flex-row items-center gap-6 mt-4 pt-4 border-t border-gray-100">
                        ...
                        <header>
                            <h2 class="text-lg font-medium text-gray-900 flex items-center gap-2">
                                ...
                                @if (isset($digitalModuleEnabled) && $digitalModuleEnabled === 'true')
                                    <span
                                        class="px-2 py-1 bg-green-100 text-green-800 text-xs font-bold rounded-full uppercase tracking-wider">Active</span>
                                @else
                                    <span
                                        class="px-2 py-1 bg-gray-100 text-gray-600 text-xs font-bold rounded-full uppercase tracking-wider">Disabled</span>
                                @endif
                            </h2>
