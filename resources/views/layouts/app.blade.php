...
<br>
            ...
            <div class="px-4 py-6 border-t border-white/10 space-y-1">
                <form method="POST" action="{{ route('logout') }}" class="px-2">
                    @csrf
                    <button type="submit"
                        class="flex items-center gap-3 px-4 py-2.5 w-full text-left text-sm font-semibold text-gray-400 hover:text-white bg-transparent hover:bg-white/10 border border-white/10 hover:border-white/20 rounded transition-all duration-200 group">
                        <svg class="w-5 h-5 flex-shrink-0 opacity-60 group-hover:opacity-100 transition-opacity" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" />
                        </svg>
                        <span class="tracking-widest uppercase text-xs">Secure Logout</span>
                    </button>
                </form>
            </div>
        </aside>
