                                                ...
                                                @if ($canAlert)
                                                    ...
                                                    @else
                                                        <form method="POST"
                                                            ...
                                                            @csrf
                                                            <button type="submit"
                                                                class="inline-flex items-center px-3 py-1.5 bg-amber-500 border border-transparent rounded-sm font-semibold text-xs text-white uppercase tracking-widest hover:bg-amber-600 transition"
                                                                onclick="return confirm('Send a reminder alert to the current holder?');">
