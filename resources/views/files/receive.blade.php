<x-app-layout>
    ...
    <div class="py-8 h-full flex flex-col" x-data="receiveForm()">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 w-full space-y-6">
            ...
            {{-- Filing Section --}}
            <form method="POST" action="{{ route('movements.receive', $movement->id) }}" x-ref="receiveForm">
                @csrf
        ...
        <div x-show="showConfirmModal" x-cloak
            ...
            <div class="relative bg-white rounded-lg shadow-2xl max-w-md w-full mx-auto p-6 text-center"
                ...
                <p class="text-sm text-gray-500 mb-6">Are you sure you want to accept custody of this document?</p>
