<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-primary leading-tight">{{ __('Create ') . App\Models\SystemTerminology::getTerm('file_jacket', 'File Jacket') }}</h2>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 w-full">
            <div class="bg-white p-6 shadow-sm border border-gray-200 rounded">
                <div class="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-900">New @term('file_jacket', 'File Jacket')</h3>
                        <p class="text-sm text-gray-500">@term('department', 'Department'): <strong>{{ $department->name }}</strong></p>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-blue-50 border border-blue-100 rounded p-3">
                            <p class="text-xs text-blue-700">
                                ...
                                your @term('department', 'department') code and sequence number (e.g.
                        ...
                        <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                            ...
                            <button type="submit"
                                class="px-6 py-2 bg-primary text-white text-sm font-semibold rounded-sm hover:bg-[#00294d] transition">Create
                                Jacket</button>
                        </div>
                    </div>
                </form>
